 ...
 */
package org.commonjava.indy.service.scheduler.exception;
...
public class SchedulerException extends Exception {
	...
	public SchedulerException(final String message, final Throwable cause, final Object... params) {
		super(message, cause);
		this.params = params;
	}

	public SchedulerException(final String message, final Object... params) {
		super(message);
		this.params = params;
	}
