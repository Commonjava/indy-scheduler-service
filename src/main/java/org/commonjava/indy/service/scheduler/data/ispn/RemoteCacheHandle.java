...
import static org.commonjava.indy.service.scheduler.data.metrics.NameUtils.name;

public class RemoteCacheHandle<K, V>
        extends BasicCacheHandle<K, V>
{

    public RemoteCacheHandle( String named, RemoteCache<K, V> cache, DefaultMetricsManager metricsManager,
                              String metricPrefix )
    {
