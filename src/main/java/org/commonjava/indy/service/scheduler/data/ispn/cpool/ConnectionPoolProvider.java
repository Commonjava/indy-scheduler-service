...
//    private MetricRegistry metricRegistry;
            ...
            throws SchedulerException
    {
        ...
        {
            throw new SchedulerException( "Failed to create JNDI InitialContext for binding datasources", e );
        }
...
//                }
            ...
            {
                throw new SchedulerException( "Failed to bind datasource: " + poolInfo.getName(), e );
            }
            catch ( SQLException e )
            {
                throw new SchedulerException( "Failed to start datasource: " + poolInfo.getName(), e );
            }
        }
    }
